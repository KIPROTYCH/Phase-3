...
def seed_data():
    ...
    restaurant1 = RestaurantModel(restaurant_name="Chicken Delight", restaurant_location="Nairobi", restaurant_cuisine="Grilled Chicken", price_level="Ksh 100")
    restaurant2 = RestaurantModel(restaurant_name="Juice Express", restaurant_location="Kisumu", restaurant_cuisine="Apple Juice", price_level="Ksh 200")
    customer1 = CustomerModel(first_name="Alice", last_name="Owen")
    customer2 = CustomerModel(first_name="Christian", last_name="Ron")
